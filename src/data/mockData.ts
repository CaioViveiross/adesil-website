...
export const products: Product[] = [
  {
    ...
    image: "/images/product-labels-1.png",
    category: "adesivas",
    badge: "Mais Vendido",
  ...
  },
  {
    ...
    price: 173.99,
    originalPrice: 194.99,
    image: "/images/product-labels-2.png",
    category: "balanca",
    specs: "10 Rolos Etiqueta 10x15 100x150 Térmica Ent. Pla Economy Cor...",
    customizable: true,
  },
  {
    ...
    price: 173.99,
    originalPrice: 194.99,
    image: "/images/product-labels-3.png",
    category: "ribbons",
    specs: "10 Rolos Etiqueta 10x15 100x150 Térmica Ent. Pla Economy Cor...",
    customizable: false,
  },
  {
    ...
    price: 173.99,
    originalPrice: 194.99,
    image: "/images/product-labels-4.png",
    category: "couche",
    specs: "10 Rolos Etiqueta 10x15 100x150 Térmica Ent. Pla Economy Cor...",
    customizable: true,
  },
...
export const categories: Category[] = [
  { id: "adesivas", name: "Etiquetas Adesivas", image: "/placeholder.svg", description: "Etiquetas autoadesivas para diversas aplicações" },
  { id: "balanca", name: "Etiquetas para Balança", image: "/images/category-mercado.jpg", description: "Compatíveis com as principais marcas" },
  { id: "ribbons", name: "Ribbons", image: "/placeholder.svg", description: "Ribbons para impressão por transferência térmica" },
  { id: "couche", name: "Couchê", image: "/placeholder.svg", description: "Etiquetas com acabamento premium" },
  { id: "personalizadas", name: "Personalizadas", image: "/placeholder.svg", description: "Crie etiquetas com seu design" },
  { id: "hospitalar", name: "Hospitalar", image: "/images/category-hospitalar.jpg", description: "Soluções para identificação hospitalar" },
];

export const businessCategories = [
  { id: "acougue", name: "Açougues", image: "/images/category-acougue.jpg" },
  { id: "mercado", name: "Mercados", image: "/images/category-mercado.jpg" },
  { id: "hospitalar", name: "Hospitalar", image: "/images/category-hospitalar.jpg" },
  { id: "papelaria", name: "Arte e Papelaria", image: "/images/category-papelaria.jpg" },
];
